@if ($page_name != 'coming_soon' && $page_name != 'contact_us' && $page_name != 'error404' && $page_name != 'error500' && $page_name != 'error503' && $page_name != 'faq' && $page_name != 'helpdesk' && $page_name != 'maintenence' && $page_name != 'privacy' && $page_name != 'auth_boxed' && $page_name != 'auth_default')
  ...
  <div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
      ...
      <ul class="list-unstyled menu-categories" id="accordionExample">
        ...
        @if ($page_name != 'alt_menu' && $page_name != 'blank_page' && $page_name != 'boxed' && $page_name != 'breadcrumb' )
          ...
          <li class="menu {{ ($category_name === 'dashboard') ? 'active' : '' }}">
            <a href="{{url('painel/admin/home')}}" aria-expanded="{{ ($category_name === 'dashboard') ? 'true' : 'false' }}" class="dropdown-toggle">
              <div class="">
          ...
          <li class="menu {{ ($category_name === 'users') ? 'active' : '' }}">
            ...
            <ul class="collapse submenu list-unstyled {{ ($category_name === 'users') ? 'show' : '' }}" id="components" data-parent="#accordionExample">
              <li class="{{ ($page_name === 'all-clients') ? 'active' : '' }}">
                <a href="{{url('painel/admin/clientes/todos')}}"> Todos </a>
              </li>
              <li class="{{ ($page_name === 'active-clients') ? 'active' : '' }}">
                <a href="{{url('painel/admin/clientes/ativos')}}"> Ativos </a>
              </li>
              <li class="{{ ($page_name === 'inactive-clients') ? 'active' : '' }}">
                <a href="{{url('painel/admin/clientes/vencidos')}}"> Vencidos  </a>
              </li>
        ...
        <li class="menu {{ ($category_name === 'employees') ? 'active' : '' }}">
          <a href="{{url('painel/admin/administradores')}}" aria-expanded="{{ ($category_name === 'employees') ? 'true' : 'false' }}" class="dropdown-toggle">
            <div class="">
      ...
      <li class="menu menu-heading">
        <div class="heading"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-minus"><line x1="5" y1="12" x2="19" y2="12"></line></svg><span>PACOTES</span></div>
      </li>

      <li class="menu {{ ($category_name === 'clients-packages') ? 'active' : '' }}">
        <a href="{{url('painel/admin/pacotes')}}" aria-expanded="{{ ($category_name === 'clients-packages') ? 'true' : 'false' }}" class="dropdown-toggle">
          <div class="">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-package"><line x1="16.5" y1="9.4" x2="7.5" y2="4.21"></line><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>
            <span>Clientes</span>
          </div>
      ...
      <li class="menu {{ ($category_name === 'resellers-invoices') ? 'active' : '' }}">
        <a href="{{url('painel/admin/financeiro/revendedores')}}" aria-expanded="{{ ($category_name === 'resellers-invoices') ? 'true' : 'false' }}" class="dropdown-toggle">
          <div class="">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-dollar-sign"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>                <span>Débitos</span>
          </div>
        </a>
      </li>
