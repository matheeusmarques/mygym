    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="form-edit-package" method="POST">
          ...
          <div class="form-group mb-4">
            <label for="formGroupExampleInput">Quantidade de Créditos</label>
            <input type="text" class="form-control" id="credits" name="credits" placeholder="Quantidade de Créditos">
          </div>
